...
make_scroll_clip "$ROOT_CAPTURE" 12 "THE PROBLEM" "Private coordination should not expose the roster." "01_hook.mp4" 465 605 0 140
...
make_scroll_clip "$ROOT_CAPTURE" 22 "THE CLOSE" "Coordinate privately. Verify openly. Reveal only the proof." "09_close.mp4" 440 600 1900 2600
