...
import { DEMO_TABS, nextDemoState } from "@shared/demo";
...
export default function DemoMode() {
  ...
  const [claimStatus, setClaimStatus] = useState("UNREDEEMED");
  const [releaseStatus, setReleaseStatus] = useState("PENDING");
  const [proofPublished, setProofPublished] = useState(false);
