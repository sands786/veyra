    ...
    <div className="min-h-screen overflow-hidden bg-[#111210] text-[#F3EEE5] selection:bg-[#70D49D] selection:text-[#111210]">
      ...
      <div className="relative z-10 flex min-h-screen">
        ...
        <main className="min-w-0 flex-1">
          ...
          <section className="border-b border-white/10 bg-[#0D1010] px-5 py-14 sm:px-8 lg:px-8 lg:py-20" aria-labelledby="veyra-teaser-title">
            <div className="mx-auto grid max-w-[1180px] gap-10 lg:grid-cols-[0.78fr_1.22fr] lg:items-end">
              <div><div className="eyebrow">VEYRA / CINEMATIC TEASER</div><h2 id="veyra-teaser-title" className="section-title mt-5">See the boundary.<br /><span>Feel the system.</span></h2><p className="mt-6 max-w-[390px] text-[14px] leading-7 text-[#AEB8BE]">A thirty-second product film for the Veyra operating model: private payroll, governed intent, sealed allocations, private markets, and receipt-backed proof.</p><div className="mt-8 flex flex-wrap gap-3 font-mono text-[9px] tracking-[0.13em]"><span className="border border-[#F0563A]/45 px-3 py-2 text-[#F0563A]">VOICEOVER</span><span className="border border-[#6DE3A1]/40 px-3 py-2 text-[#6DE3A1]">ORIGINAL SCORE</span><span className="border border-white/15 px-3 py-2 text-[#AEB8BE]">30 SECONDS</span></div></div>
              <div className="border border-[#F0563A]/55 bg-[#101312] p-3 shadow-[0_24px_70px_rgba(0,0,0,0.38)]"><div className="mb-3 flex items-center justify-between font-mono text-[10px] tracking-[0.14em] text-[#F0563A]"><span>WATCH / VEYRA FILM</span><span className="border border-[#6DE3A1]/45 px-2 py-1 text-[8px] text-[#6DE3A1]">30 SEC</span></div><video className="aspect-video w-full border border-white/15 bg-black object-cover" controls playsInline preload="metadata" aria-label="Thirty-second Veyra teaser with voiceover and original score"><source src="https://files.manuscdn.com/user_upload_by_module/session_file/310519663488625248/UWySWLIQYVhglQGv.mp4" type="video/mp4" />Your browser does not support the Veyra teaser.</video><div className="flex flex-wrap items-center justify-between gap-3 pt-3 font-mono text-[8px] tracking-[0.11em] text-[#D5CEC4]"><span>VOICEOVER · ORIGINAL SCORE · STABLE PRODUCT MOTION</span><span className="text-[#AEB8BE]">WALLET → RECEIPT → PROOF</span></div></div>
            </div>
          </section>
