        ...
        <main className="min-w-0 flex-1">
          ...
          <section className="relative isolate overflow-hidden border-b border-white/10 px-5 py-11 sm:px-8 lg:px-8 lg:py-14">
            ...
            <div className="max-w-[900px]">
              ...
              <div className="mt-9 flex flex-wrap items-center gap-3 sm:gap-5"><Button onClick={() => document.getElementById("route-builder")?.scrollIntoView({ behavior: "smooth" })} className="group h-12 rounded-full bg-[#F3EEE5] px-6 font-mono text-[10px] tracking-[0.13em] text-[#111210] hover:bg-white">CREATE PRIVATE ROUTE <ArrowUpRight className="ml-2 transition-transform group-hover:translate-x-1 group-hover:-translate-y-1" size={15} /></Button><a href="https://files.manuscdn.com/user_upload_by_module/session_file/310519663488625248/WAylyKACYnLBqMYS.mp4" target="_blank" rel="noreferrer" className="group inline-flex h-12 items-center rounded-full border border-[#F0563A]/65 bg-[#111210]/70 px-5 font-mono text-[10px] tracking-[0.13em] text-[#F3EEE5] transition hover:border-[#F0563A] hover:bg-[#F0563A] hover:text-[#111210]" aria-label="Watch the eight-second Veyra teaser in a new tab"><PlayCircle className="mr-2 text-[#F0563A] transition-colors group-hover:text-[#111210]" size={15} />WATCH VEYRA TEASER <span className="ml-2 text-[8px] opacity-75">08 SEC</span></a><span className="font-mono text-[10px] leading-5 tracking-[0.1em] text-[#AEB8BE]">PUBLICLY VERIFIABLE<br />AFTER RECEIPT CONFIRMATION</span></div>
            </div>
          </section>
