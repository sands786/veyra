      ...
      <div className="relative z-10 flex min-h-screen">
        <aside className="hidden w-[204px] shrink-0 border-r border-[#163B4A]/70 bg-[#111210]/95 px-5 py-6 lg:flex lg:flex-col">
          <div className="flex items-center gap-3">
            <img src="/manus-storage/veyra-starknet-mark_de44c357.png" alt="Veyra legacy privacy mark" className="h-11 w-11 object-contain drop-shadow-[0_0_18px_rgba(112,212,157,.22)]" />
            <div>
