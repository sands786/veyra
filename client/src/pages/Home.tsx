        ...
        <main className="min-w-0 flex-1">
          ...
          <section className="relative isolate overflow-hidden border-b border-white/10 px-5 py-11 sm:px-8 lg:px-8 lg:py-14">
            ...
            <div className="max-w-[900px]">
              ...
              <div className="mt-8 max-w-[365px] border border-[#F0563A]/45 bg-[#101312]/88 p-3 backdrop-blur xl:hidden"><div className="mb-2 flex items-center justify-between font-mono text-[9px] tracking-[0.14em] text-[#F0563A]"><span>VEYRA / CINEMATIC TEASER</span><span className="border border-[#6DE3A1]/35 px-2 py-1 text-[8px] text-[#6DE3A1]">30 SEC</span></div><video className="aspect-video w-full border border-white/10 bg-black object-cover" controls playsInline preload="metadata" aria-label="Thirty-second Veyra teaser with voiceover and original score"><source src="https://files.manuscdn.com/user_upload_by_module/session_file/310519663488625248/EScXSEXzwgSkPaYT.mp4" type="video/mp4" />Your browser does not support the Veyra teaser.</video><div className="pt-2 font-mono text-[8px] tracking-[0.11em] text-[#AEB8BE]">VOICEOVER · ORIGINAL SCORE · PRODUCT MOTION</div></div>
            </div>
            <div className="absolute right-6 top-[53%] z-10 hidden w-[320px] -translate-y-1/2 border border-[#F0563A]/70 bg-[#101312]/95 p-3 shadow-[0_18px_60px_rgba(0,0,0,0.48)] backdrop-blur xl:block"><div className="mb-2 flex items-center justify-between font-mono text-[9px] tracking-[0.14em] text-[#F0563A]"><span>VEYRA / CINEMATIC TEASER</span><span className="border border-[#6DE3A1]/50 px-2 py-1 text-[8px] text-[#6DE3A1]">30 SEC</span></div><video className="aspect-video w-full border border-white/15 bg-black object-cover" controls playsInline preload="metadata" aria-label="Thirty-second Veyra teaser with voiceover and original score"><source src="https://files.manuscdn.com/user_upload_by_module/session_file/310519663488625248/EScXSEXzwgSkPaYT.mp4" type="video/mp4" />Your browser does not support the Veyra teaser.</video><div className="pt-2 font-mono text-[8px] tracking-[0.11em] text-[#D5CEC4]">VOICEOVER · ORIGINAL SCORE · PRODUCT MOTION</div></div>
          </section>
