  ...
  async function handleWalletConnect() {
    ...
    try {
      ...
      if (!result.live || !result.wallet) {
        toast("No privacy-enabled Starknet wallet detected.", { description: "Veyra stays in demo mode until a STRK20 wallet is available." });
        return;
      }
