...
export default function Home() {
  ...
  function goToSection(section: "routes" | "ledger" | "identity") {
    setActiveSection(section);
    const target = section === "routes" ? "route-builder" : section === "ledger" ? "proof-ledger" : "identity-keys";
