...
function CinematicVeyraMark({ className }: { className: string }) {
  return (
    ...
    >
      ...
      <path
        d="M44 4 78 18v33c0 21-13.2 36.8-34 47C23.2 87.8 10 72 10 51V18L44 4Z"
        fill="#111210"
        fillOpacity="0.6"
        stroke="url(#veyra-metal)"
        strokeWidth="2.2"
        filter="url(#veyra-glow)"
      />
      <path
        d="M44 11 71 23v27.1c0 16.3-9.9 29.2-27 38.6-17.1-9.4-27-22.3-27-38.6V23l27-12Z"
        stroke="#EDE9DE"
        strokeOpacity="0.72"
        strokeWidth="1.2"
      />
      <path
        d="m24.5 29.5 11.1 0 9.2 31.1-5.5 11.7L24.5 29.5Z"
        fill="url(#veyra-v-metal)"
        stroke="#F3EEE5"
        strokeOpacity="0.86"
        strokeWidth="1.05"
      />
      <path
        d="m61.5 29.5-13.8 30.2 5.5 12.6 15.3-42.8H61.5Z"
        stroke="#F3EEE5"
        strokeOpacity="0.92"
        strokeWidth="1.4"
      />
...
export function VeyraBrand({
  ...
  return (
    ...
    >
      <CinematicVeyraMark
        className={`${markSize} shrink-0 drop-shadow-[0_0_18px_rgba(112,212,157,.22)]`}
      />
      <span
        className={`${mobileMarkOnly ? "hidden sm:inline" : ""} font-display ${wordmarkSize} font-semibold leading-none tracking-[-0.055em] text-[#F3EEE5]`}
      >
        Veyra
      </span>
    </div>
